...
//
// Note: TMS320C28x Byte is 16Bits, so int8/Uint8 actually equal to int16/Uint16. 
// We do so for code compatibility with other CPUs. When use int8 and Uint8, 
// be sure the value not exceed [-128, 127] or [0, 255].
//
