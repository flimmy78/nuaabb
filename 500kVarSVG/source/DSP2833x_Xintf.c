...
//--- Zone 6 Configuration
	XintfRegs.XTIMING6.bit.X2TIMING = 1;	// Timing scale factor = 1
	...
	XintfRegs.XTIMING6.bit.XRDLEAD = 3;		// Read lead time
	XintfRegs.XTIMING6.bit.XRDACTIVE = 7;	// Read active time
	XintfRegs.XTIMING6.bit.XRDTRAIL = 3;	// Read trail time
	XintfRegs.XTIMING6.bit.XWRLEAD = 3;		// Write lead time
	XintfRegs.XTIMING6.bit.XWRACTIVE = 7;	// Write active time
	XintfRegs.XTIMING6.bit.XWRTRAIL = 3;	// Write trail time
